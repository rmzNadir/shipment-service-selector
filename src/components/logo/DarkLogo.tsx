...
export const DarkLogo = ({ isExtraSmallScreen }: DarkLogoProps) => {
  const width = isExtraSmallScreen ? 32 : 210;

  return (
    <svg
      version="1.1"
      id="Layer_1"
      data-testid="dark-logo"
      ...
      enableBackground={`new 0 0 ${width} 30`}
      xmlSpace="preserve"
    >
      <g>
        <g>
          <g>
            <path
              fill="#5333ea"
              d="M23.8,33.7l-1.7-5.3c1.1-0.2,2.1-0.8,2.9-1.6c0.9-0.9,1.3-2.2,1.3-3.9c0-1.4-0.4-2.5-1.2-3.4
         ...
         C25.6,33.2,24.7,33.5,23.8,33.7z"
          ...
          <ellipse
            transform="matrix(1.464942e-02 -0.9999 0.9999 1.464942e-02 -8.5197 53.636)"
            fill="#e46475"
            cx="23"
            cy="31.1"
            rx="3.2"
          ...
          <ellipse
            transform="matrix(1.464942e-02 -0.9999 0.9999 1.464942e-02 -5.5191 23.0637)"
            fill="#6AD0F4"
            cx="8.9"
            cy="14.3"
            rx="3.2"
        ...
        {!isExtraSmallScreen && (
          <g>
            <path
              fill="#0c005a"
              d="M41.9,27.2l3.9-1.4c0.2,1.2,0.7,2.2,1.5,2.9s2.1,1.2,3.5,1.2c1.2,0,2.1-0.3,2.7-0.8
       ...
       c-1.4,1.4-3.4,2.1-5.9,2.1c-2.7,0-4.8-0.7-6.3-2C42.9,30.2,42.1,28.8,41.9,27.2z"
            ...
            <path
              fill="#0c005a"
              d="M81.8,11.1l-9.3,9.2L82,32.9h-5.4l-7.1-9.6l-3,3v6.6h-4.2V0h4.2v20.7l9.5-9.7H81.8z"
            />
            <path
              fill="#0c005a"
              d="M89.3,42.1h-4.7L90,30.5l-9.4-19.5h4.9l6.8,15.1l6.5-15.1h4.6L89.3,42.1z"
            />
            <path
              fill="#0c005a"
              d="M119.7,30v-0.4c-0.6,1.1-1.4,2.1-2.6,2.8c-1.2,0.7-2.6,1.1-4.2,1.1c-3.1,0-5.6-1.1-7.5-3.3
       ...
       C107.5,17.8,106.9,19.6,106.9,21.9z"
            ...
            <path
              fill="#0c005a"
              d="M141,10.8v4.5c-0.6-0.1-1.3-0.1-1.9-0.1c-4,0-6,2.2-6,6.7v11h-4.3V11.1h4.2v3.8
       c1.3-2.8,3.5-4.2,6.5-4.2C140.1,10.7,140.6,10.7,141,10.8z"
            />
            <path
              fill="#0c005a"
              d="M144.4,13.7c2.1-2.2,4.8-3.3,8-3.3c3.2,0,5.9,1.1,8,3.3c2.1,2.2,3.2,5,3.2,8.3c0,3.4-1,6.1-3.1,8.3
       ...
       c-1.3,1.4-2,3.3-2,5.7C145.6,24.4,146.3,26.3,147.6,27.7z"
            ...
            <path
              fill="#0c005a"
              d="M171,41.6h-4.2V11.1h4.1v3.4c0.6-1.2,1.6-2.1,2.9-2.8c1.3-0.7,2.8-1.1,4.5-1.1
       ...
       c-1.2,1.4-1.8,3.3-1.8,5.5c0,2.3,0.6,4.1,1.8,5.6c1.2,1.4,2.8,2.2,4.7,2.2c1.9,0,3.5-0.7,4.7-2.2C183.4,26.1,184,24.2,184,22z"
            ...
            <path
              fill="#0c005a"
              d="M187.9,32.9l8.1-11.1l-7.9-10.7h5.2l5.4,7.7l5.3-7.7h5l-7.8,10.7c0.5,0.6,1.8,2.4,4,5.6
